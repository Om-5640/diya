...
from core.types import REASON_CODES, BatterySpec, DieselSpec, DispatchPlan, StepResult
...
def reason_for_planned_step(
    ...
    evaluated in a fixed priority order; the first match wins.
    """
    if plan.unserved_critical_kwh[0] > 1e-6:
        return _reason("R8_CRITICAL_DEFICIT")
